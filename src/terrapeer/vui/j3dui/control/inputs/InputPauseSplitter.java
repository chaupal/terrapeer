...
public class InputPauseSplitter
 implements InputPauseTarget {
	
	// public interface =========================================

	/**
	Constructs an InputPauseSplitter with no event targets.
	*/
	public InputPauseSplitter() {}
	...
	changed.
	*/
	public boolean addEventTarget(InputPauseTarget target) {
...
if(Debug.getEnabled()){
Debug.println("InputPauseSplitter",
"SPLIT:InputPauseSplitter:setInputPause:" +
" pause=" + pause);}

		Iterator targetI = getEventTargets();
		while(targetI.hasNext()) {
			InputPauseTarget target =
			 (InputPauseTarget)targetI.next();
		
			target.setInputPause(pause);
		}
