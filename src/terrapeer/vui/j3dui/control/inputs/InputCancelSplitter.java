...
public class InputCancelSplitter
 implements InputCancelTarget {
	
	// public interface =========================================

	/**
	Constructs an InputCancelSplitter with no event targets.
	*/
	public InputCancelSplitter() {}
	...
	changed.
	*/
	public boolean addEventTarget(InputCancelTarget target) {
...
if(Debug.getEnabled()){
Debug.println("InputCancelSplitter",
"SPLIT:InputCancelSplitter:setInputCancel: -");}

		Iterator targetI = getEventTargets();
		while(targetI.hasNext()) {
			InputCancelTarget target =
			 (InputCancelTarget)targetI.next();
		
			target.setInputCancel();
		}
